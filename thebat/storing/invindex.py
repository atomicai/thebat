...
import numpy as np
from thebat.etc.schema import Document, FilterType
...
class IBM25Store:
    def query_by_embedding(
        ...
        documents = [
            self._convert_es_hit_to_document(hit, adapt_score_for_embedding=True, scale_score=scale_score) for hit in result
        ]
        return documents
